      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal delay={400}>
          <div className="text-center mt-12">
            <Link
              href="/services"
              className="inline-block px-8 py-4 rounded-lg font-semibold text-white bg-gradient-primary hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 hover:scale-105"
            >
              View All Services
            </Link>
          </div>
